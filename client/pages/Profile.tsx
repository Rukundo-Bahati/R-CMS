        ...
        <div className="lg:col-span-4 space-y-6">
          <Card className="p-6">
            <div className="flex flex-col items-center text-center">
              <div className="relative group">
                ...
                {isEditing && (
                  <button className="absolute bottom-2 right-2 bg-card p-2 rounded-full shadow-md border border-border hover:bg-muted transition-colors">
          ...
          {showPasswordDialog && (
            <div className="fixed inset-0 bg-background/80 backdrop-blur-sm flex items-center justify-center z-50 p-4">
              <div className="bg-card rounded-lg w-full max-w-md p-6 shadow-xl border border-border">
                ...
                <form onSubmit={handlePasswordSubmit} className="space-y-4">
                  {passwordError && (
                    <div className="p-3 bg-red-500/10 text-red-700 dark:text-red-400 text-sm rounded-md border border-red-500/20">
                      {passwordError}
                    </div>
                  )}

                  <div>
                    <Label htmlFor="currentPassword" title="Current Password" className="block text-sm font-medium text-muted-foreground mb-1">
                      Current Password
                    </Label>
                    <Input
                      id="currentPassword"
                  ...
                  <div>
                    <Label htmlFor="newPassword" title="New Password" className="block text-sm font-medium text-muted-foreground mb-1">
                      New Password
                    </Label>
                    <Input
                      id="newPassword"
                  ...
                  <div>
                    <Label htmlFor="confirmPassword" title="Confirm New Password" className="block text-sm font-medium text-muted-foreground mb-1">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  {isEditing ? (
                    ...
                    <p className="mt-2 text-foreground">{formData.name.split(' ')[0]}</p>
                  )}
                </div>
                <div>
                  ...
                  {isEditing ? (
                    ...
                    <p className="mt-2 text-foreground">{formData.name.split(' ').slice(1).join(' ')}</p>
                  )}
                </div>
              </div>
