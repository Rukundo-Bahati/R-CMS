                ...
                {success ? (
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative">
                                ...
                                <input
                                    type="email"
                                    required
                                    className="w-full pl-10 pr-4 py-3 bg-gray-100 border border-gray-200 rounded-xl outline-none"
                                    value={email}
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative group">
                                ...
                                <input
                                    ...
                                    required
                                    className="w-full pl-10 pr-12 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-indigo-500 outline-none"
                                    placeholder="••••••••"
                                    value={password}
                        ...
                        <Button
                            type="submit"
                            disabled={loading}
                            className="w-full py-6 mt-2 rounded-xl bg-indigo-600 hover:bg-indigo-700 text-white font-bold shadow-lg"
                        >
