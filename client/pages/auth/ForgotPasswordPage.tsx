        ...
        <div className="min-h-screen flex items-center justify-center bg-gray-50 p-4">
            <Card className="w-full max-w-md p-8 shadow-xl border-none">
                <div className="mb-8">
                    ...
                    <p className="text-gray-500 mt-2">No worries, we'll send you a reset code via email.</p>
                </div>
                ...
                {success ? (
                    <div className="text-center py-4">
                        ...
                        <h3 className="text-xl font-bold text-gray-900">Code Sent!</h3>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <Button
                            type="submit"
                            disabled={loading}
                            className="w-full py-6 rounded-xl bg-indigo-600 hover:bg-indigo-700 text-white font-bold shadow-lg"
                        >
