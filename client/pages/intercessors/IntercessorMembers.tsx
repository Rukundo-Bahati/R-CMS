...
import { Users, Search, Mail, Phone, Heart, Plus } from "lucide-react";
import {
  Dialog,
  DialogContent,
  DialogHeader,
...
const initialMembers: Member[] = [
  ...
  },
  {
    id: 2,
    name: "Emmanuel Nkusi",
    email: "emmanuel.nkusi@church.com",
  ...
  },
  {
    ...
    email: "esther.mukamana@church.com",
  ...
  },
  {
    ...
    email: "daniel.habimana@church.com",
...
export default function IntercessorMembers() {
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          <h1 className="text-2xl md:text-3xl font-bold text-gray-900">Intercessor Members</h1>
          <p className="text-gray-500 mt-1">Manage prayer team members</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <Card className="p-5">
          <p className="text-sm font-medium text-gray-600">Lead Intercessors</p>
          <p className="text-2xl font-bold text-gray-900 mt-1">
            {members.filter((m) => m.role === "Lead Intercessor").length}
          </p>
        </Card>
      </div>
            ...
            <tbody>
              {filteredMembers.map((member) => (
                <tr key={member.id} className="border-b hover:bg-gray-50">
                  ...
                  <td className="py-3 px-4 text-gray-700">{member.joinDate}</td>
                  <td className="py-3 px-4">
                    <span
          ...
          <div className="space-y-4 py-4">
            ...
            <div>
              ...
              >
                ...
                <option value="Lead Intercessor">Lead Intercessor</option>
