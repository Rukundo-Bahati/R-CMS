    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div>
                    <h1 className="text-2xl md:text-3xl font-bold text-foreground">Usher Dashboard</h1>
                    <p className="text-muted-foreground mt-1">Manage attendance, duties, and church assets</p>
                </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <Card className="p-6">
                    <div className="flex items-center justify-between mb-4">
                        <h3 className="text-lg font-semibold text-foreground">Upcoming Duties</h3>
                        <Button
                            variant="outline"
                            size="sm"
                    ...
                    <div className="space-y-4">
                        {upcomingDutiesData.map((duty) => (
                            <div key={duty.id} className="flex items-start gap-3 p-3 hover:bg-accent rounded-lg transition-colors border border-transparent hover:border-border">
                                <div className="bg-primary/10 p-2 rounded-lg">
                                    <DoorOpen className="w-5 h-5 text-primary" />
                                </div>
                                <div className="flex-1">
                                    <p className="font-medium text-foreground">{duty.title}</p>
                                    <p className="text-sm text-muted-foreground">{duty.date} • {duty.time}</p>
                                    <p className="text-xs text-muted-foreground/60 mt-1">Assigned: {duty.assignedTo}</p>
                                </div>
                            </div>
                        ))}
                    </div>
