  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          <h1 className="text-2xl md:text-3xl font-bold text-foreground">Intercessor Dashboard</h1>
          <p className="text-muted-foreground mt-1">Manage prayer sessions, members, and schedules</p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card className="p-6">
          <div className="flex justify-between items-center mb-4">
            <h3 className="text-lg font-semibold text-foreground">Prayer Requests by Category</h3>
          </div>
          <div className="h-80">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card className="p-6">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-lg font-semibold text-foreground">Upcoming Prayer Sessions</h3>
            <Button
              variant="outline"
              size="sm"
          ...
          <div className="space-y-4">
            {upcomingPrayerSessions.map((session) => (
              <div key={session.id} className="flex items-start gap-3 p-3 hover:bg-accent rounded-lg transition-colors border border-transparent hover:border-border">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-muted-foreground/60 mt-1">Location: {session.location}</p>
                </div>
              </div>
            ))}
          </div>
